											...
											<div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow" data-bs-popper="none">
												...
												<div class="message-menu ps2 overflow-hidden">
													<a class="dropdown-item d-flex" href="chat.html">
														<span class="avatar avatar-md brround me-3 align-self-center cover-image" data-bs-image-src="{{asset('dashboard/assets/images/users/1.jp')}}g"></span>
														<div class="wd-90p">
															<div class="d-flex">
                    ...
                    <div class="modal-content country-select-modal">
                        ...
                        <div class="modal-body">
                            <ul class="row row-sm p-3">
                                ...
                                <li class="col-lg-4 mb-2">
                                    <a class="btn btn-country btn-lg btn-block">
                                        <span class="country-selector"><img alt="russia" src="{{asset('dashboard/assets/images/flags/russia_flag.jpg')}}" class="me-2 language"></span>Russia
                                    </a>
                                </li>
                                <li class="col-lg-4 mb-2">
                                    <a class="btn btn-country btn-lg btn-block">
